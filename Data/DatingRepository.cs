    ...
    public class DatingRepository : IDatingRepository {
        ...
        public async Task<PagedList<User>> GetUsers(UserParams userParams)
        {
            ...
            if (userParams.Likers)
            {
                ...
                users = users.Where(u => userLikes.Any(liker => liker.LikerId == u.Id));
            }
            
            if (userParams.Likees)
            {
                var userLikes = await GetUserLikes(userParams.UserId, userParams.Likers);
                users = users.Where(u => userLikes.Any(likee => likee.LikeeId == u.Id));
            }
        ...
        public Task<PagedList<Message>> GetMessagesForUsers(MessageParams messageParams)
        {
